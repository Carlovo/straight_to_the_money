...
- Optionally, pull in any dependencies with `uv add some_lib_you_need`. This will also initiate the uv.lock file. You can also run `uv lock` to init the lock file without adding any dependencies.
